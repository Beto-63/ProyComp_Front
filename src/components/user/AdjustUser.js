            ...
            .then(async (resp)=>{ // (primer .then)
                ...
                switch (resp.status) {
                    ...
                    case 200:
                        ...
                        setUbicaciones(json); // Recibo de información del backend en json (Segundo .then)
                        //window.alert(json);
                        //navigate("/");
                        break;
            ...
            .then(async (resp)=>{ // (primer .then)
                ...
                switch (resp.status) {
                    ...
                    case 201:
                        ...
                        setRoles(json); // Recibo de información del backend en json (Segundo .then)
                        //window.alert(json);
                        //navigate("/");
                        break;
    ...
    const handleUser = () => {
        ...
        .then(async (resp)=>{ // (primer .then)
            ...
            switch (resp.status) {
                ...
                case 400:
                    window.alert("400: Usuario no encontrado");
                    //navigate("/");
                    break;
